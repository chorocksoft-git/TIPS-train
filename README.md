...
본 저장소는 객체 탐지 알고리즘의 학습, 검증을 위한 소스코드를 포함하고 있습니다.

## 1. 프로젝트 개요
* **목적**: 전술 환경에서의 객체(총기, 군복, 장비, 드론 등 10종) 실시간 탐지 및 분류 알고리즘 개발
* **핵심 모델**: YOLO v11m (Medium 모델 기반 최적화)
* **주요 성과**: **mAP50 기준 91.6%** 달성
...
* **광학 및 기상 증강**: BGR(0.1) 채널 반전을 통한 역광 대응, HSV_S(0.5) 및 HSV_V(0.5) 변환 폭 확장을 통한 안개·눈부심 가혹 환경 모사
